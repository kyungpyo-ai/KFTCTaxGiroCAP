...
- [ ] 메인 화면 비노출 정책 (PRD §5.1) — **미착수**
- [ ] ESC 키 Hooking (PRD §5.3) — **미착수**
...
여기서 멈추고 추후 재개**하며, 대신 **실제 결제 로직에 필요한 P13-2(취소 1회 제한)부터 이어서
구현**하기로 함(2026-08-24). P13-2는 완료(위 체크리스트). **P13-4(표시 정책)/P13-5(ESC 전역 훅)/
